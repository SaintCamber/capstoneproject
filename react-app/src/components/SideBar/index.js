...
export default function SideBar() {
  ...
  const enableSearch = (e) => {
    e.preventDefault();
    return !searching ? setSearching(true) : setSearching(false);
  };
    ...
    <div className="SideBar">
      ...
      <div className="SideBar__navContainer">
        ...
        <div
          ...
          onClick={() =>
            alert("Library coming soon! please pick a playlist instead!")
          }
        >
      ...
      <div className="SideBar__devInfo">
        ...
        <>
          <Link
            className="Links"
            to={{
              pathname: "https://www.linkedin.com/in/sarah-nodwell-77a171217",
            }}
            target="_blank"
          >
            linkedin
        ...
        <>
          <Link
            className="Links"
            to={{ pathname: "https://github.com/SaintCamber" }}
            target="_blank"
          >
            github
          </Link>
